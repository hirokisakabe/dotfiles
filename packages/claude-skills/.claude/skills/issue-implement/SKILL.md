...
description: GitHub issue 番号を起点に、実装 → cross-review → commit → PR 作成 → CI 確認まで一気通貫で進める。ユーザーから「issue #N を実装して」「#N お願い」などの依頼があった場合に使用する。
---
...
- **含む**: Status 確認、親 issue の文脈取り込み、実装、cross-review、commit、PR 作成、CI 確認・修正。
...
### 5. cross-review (codex-review skill)
